...
ul.innerHTML = `<li>${link(
  'Inicio',
  ' link_header',
  `#presentacion`
)} </li> <li>${link('Experiencia', ' link_header ', `#experiencia-estudios`)}
...
footer.innerHTML =
  '<p>Andrés Segura Gonzalez</p> <p>Proyecto 4</p> <p>Por suerte he elegido estudiar programación y no diseño</p>'
